...
const SAMPLE_PHYSICIANS: Physician[] = [
  ...
  },
  {
    ...
    coordinates: [-79.6876, 43.4675] as [number, number],
    phone: "",
  ...
  },
  {
    ...
    coordinates: [-79.7624, 43.6845] as [number, number],
    phone: "905-857-3474",
    email: "",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  // Kitchener Family Physicians
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "535 Belmont Ave W, Kitchener, Ontario, Canada",
    coordinates: [-80.4934, 43.4516] as [number, number],
    phone: "(519) 571-3295",
    officeHours: "By Appointment",
    telehealthAvailable: false,
    accepting: true,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "110-525 Belmont Ave W, Kitchener ON N2M 5E2",
    coordinates: [-80.4934, 43.4516] as [number, number],
    phone: "(519) 621-9257",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    subspecialty: "",
    yearsInPractice: 0,
    affiliatedHospitals: ["Sanctuary Refugee Health Centre"],
    academicTitles: [],
    clinicName: "",
    address: "405-564 Belmont Ave West, Kitchener ON N2M 5N6",
    coordinates: [-80.4934, 43.4516] as [number, number],
    phone: "(226) 666-2404",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    affiliatedHospitals: [],
    academicTitles: [],
    clinicName: "Oshawa Medical Centre",
    address: "450 Westheights Dr, Unit 11, Kitchener ON N2N 2B9",
    coordinates: [-80.5204, 43.4400] as [number, number],
    phone: "(519) 725-4070",
    officeHours: "By Appointment",
    telehealthAvailable: false,
    accepting: true,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "10 Westheights Dr, Suite 201, Kitchener",
    coordinates: [-80.5204, 43.4400] as [number, number],
    phone: "(519) 578-5555",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "16 Andrew St, Kitchener",
    coordinates: [-80.4866, 43.4531] as [number, number],
    phone: "(519) 804-9050",
    officeHours: "By Appointment",
    telehealthAvailable: false,
    accepting: true,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "Unit 14, 450 West Heights Dr, Kitchener ON N2N 2B9",
    coordinates: [-80.5204, 43.4400] as [number, number],
    phone: "(519) 584-7411",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    affiliatedHospitals: [],
    academicTitles: [],
    clinicName: "Benton Medical Clinic",
    address: "51 Benton Street, Kitchener ON N2G 3H1",
    coordinates: [-80.4866, 43.4531] as [number, number],
    phone: "(226) 240-3014",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "450 Westheights Drive, Kitchener ON N2N 2B9",
    coordinates: [-80.5204, 43.4400] as [number, number],
    phone: "(519) 725-4070",
    officeHours: "By Appointment",
    telehealthAvailable: false,
  ...
  },
  {
    ...
    coordinates: [-80.4600, 43.4400] as [number, number],
    phone: "(519) 900-8950",
    officeHours: "By Appointment",
    telehealthAvailable: false,
    accepting: true,
  ...
  // Waterloo Family Physicians
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "570 University Ave E, Suite 902, Waterloo",
    coordinates: [-80.5204, 43.4643] as [number, number],
    phone: "(519) 570-1280",
    officeHours: "By Appointment",
    telehealthAvailable: false,
    accepting: true,
  ...
  },
  {
    ...
    academicTitles: [],
    clinicName: "",
    address: "430 The Boardwalk, Suite 302, Waterloo",
    coordinates: [-80.5204, 43.4643] as [number, number],
    phone: "(519) 578-8050",
    officeHours: "By Appointment",
    telehealthAvailable: false,
