        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-center max-w-3xl mx-auto mb-16 text-gray-600">
              Meet the dedicated professionals working to bridge healthcare gaps for Middle Eastern communities.
            </p>
            
            <div className="text-center py-12">
              <p className="text-xl">Team members profile content coming soon.</p>
            </div>
          </div>
        </section>
      </main>
